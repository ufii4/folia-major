...
export default {
  ...
  "options": {
    ...
    "discordRichPresenceDesc": "Show the current Folia track in Discord desktop. Requires the Discord desktop app to be running.",
    "discordApplicationId": "Discord Application ID",
    "discordApplicationIdOverride": "Application ID override",
    "discordApplicationIdDesc": "Leave empty to use Folia default. Only fill this when testing another Discord application.",
    "saveDiscordApplicationId": "Save ID",
    "discordPresenceDisabled": "Disabled",
    "discordPresenceMissingId": "Missing Application ID",
