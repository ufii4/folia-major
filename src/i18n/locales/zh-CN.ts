...
export default {
  ...
  "options": {
    ...
    "discordRichPresenceDesc": "在 Discord 桌面端展示 Folia 当前播放歌曲。需要 Discord 桌面端正在运行。",
    "discordApplicationId": "Discord Application ID",
    "discordApplicationIdOverride": "Application ID 覆盖",
    "discordApplicationIdDesc": "留空时使用 Folia 内置 ID。只有测试其他 Discord 应用时才需要填写。",
    "saveDiscordApplicationId": "保存 ID",
    "discordPresenceDisabled": "未启用",
    "discordPresenceMissingId": "缺少 Application ID",
